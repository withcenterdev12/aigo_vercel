...
export default function Section_3() {
  ...
  return (
    <section className="flex h-[1420px] w-full flex-col px-[16px]">
      <h2 className="text-on-bg-a-9 text-28b-emphasis-title mt-[25px]">
        에이고 효과
      </h2>
      ...
      <div className="mt-[60px] flex flex-col items-center gap-[24px] sm:flex-row">
        ...
        <div className="flex h-[400px] w-full flex-col rounded-[8px] bg-gradient-to-b from-[#627DFE] to-[#4361FF] px-[26px]">
          <h3 className="text-24sb-title1 mt-[32px] text-white">매출 증대</h3>
          <p className="text-16sb-body mt-[12px] text-white">
            고객 DB 확보, 견적문의 <br />
            최소 2~10배 증가로 매출 증대
          </p>
        </div>
        ...
        <div className="flex h-[400px] w-full flex-col rounded-[8px] bg-gradient-to-b from-[#7A6DFF] to-[#6750FE] px-[26px]">
          <h3 className="text-24sb-title1 mt-[32px] text-white">
            업무 효율 증가
          </h3>
          <p className="text-16sb-body mt-[12px] text-white">
          ...
          <p className="text-12r-tag mt-[10px] text-white">
            *기존 단순 광고 (문의접수 대비)량
          </p>
        </div>
        {/* Card 3 */}
