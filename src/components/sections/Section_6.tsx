export default function Section_6() {
  return (
    <section className="mt-[25px] h-[790px] w-full bg-gradient-to-b from-[#FFFFFF] to-[#ECEFFE] px-[16px] sm:px-[105px]">
      ...
      <div className="mt-[60px] grid grid-cols-2 gap-[52px] sm:gap-[80px]">
        ...
        {/* Item 2 */}
        <div className="flex flex-col gap-[11px]">
          <span className="text-mobile-20sb-title2 sm:text-pc-26sb-title flex flex-row items-center bg-gradient-to-r from-[#8AA5FF] to-[#4C60FF] bg-clip-text text-transparent">
            <img
          ...
          <p className="text-mobile-16sb-body text-on-bg-a-2 sm:text-pc-20sb-body">
            서비스를 끝까지 사용하지 않더라도, 대화이력 (채팅 및 파일) 모두 확인
            가능.
          </p>
        </div>
        {/* Item 3 */}
      ...
      <div className="mt-[80px] hidden flex-col gap-[11px] sm:flex">
        <span className="text-mobile-20sb-title2 sm:text-pc-26sb-title flex flex-row items-center bg-gradient-to-r from-[#8AA5FF] to-[#4C60FF] bg-clip-text text-transparent">
          <img
            src="/images/icon_5.svg"
            className="mr-[4px] h-[32px] w-[32px] sm:h-[36px] sm:w-[36px]"
