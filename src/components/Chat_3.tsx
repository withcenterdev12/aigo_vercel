...
export default function Chat_3() {
  return (
    <>
      <div className="text-mobile-16r-body-light bg-bg-d mt-[40px] mb-[20px] flex h-[1080px] w-full flex-col px-[16px] py-[40px] sm:mt-[0px] sm:mb-[0px] sm:max-w-[720px]">
        ...
        <div className="text-on-tag-1 bg-tag-1 mt-[8px] w-[300px] rounded-t-[12px] rounded-br-[12px] px-[14px] py-[8px] leading-tight">
          <p>
            안녕하세요 2차전지 배터리팩 AI 컨설턴트
            <br />
            강상희 입니다. 만나 뵙게 반갑습니다
          </p>
          <p className="mt-[12px] leading-tight">
            어떤 배터리 팩을 만들고싶으신지 말씀해 주 <br />
            시겠어요?
          </p>
        </div>
        ...
        <div className="text-on-tag-1 bg-tag-1 mt-[8px] w-[302px] rounded-t-[12px] rounded-br-[12px] px-[14px] py-[8px] leading-tight">
          <p>
            해당 사이트 확인 결과 전기 카트 BA100 모
            <br />
            델에 들어 가는 배터리팩을 찾으시는것 같네
            <br />
            요.
          </p>
          <p className="mt-[12px] leading-tight">
            관련해서 배터리팩 스팩은 3S 20P로 확인
            <br />
            됩니다 관련 모델로 견적 산출해 드리면 될까
            <br />
            요?
          </p>
        </div>
